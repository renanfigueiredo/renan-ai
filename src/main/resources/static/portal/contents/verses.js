window.Verses = {
  ...
  "2Tm 2:2": "E o que, da minha parte, ouviste através de muitas testemunhas, isso mesmo transmite a homens fiéis e também idôneos para instruir a outros.",
  ...
  // Novos versículos para liderança bíblica
  "1Tm 3:1-13": "Fiel é a palavra: Se alguém aspira ao episcopado, excelente obra almeja. É necessário, portanto, que o bispo seja irrepreensível, esposo de uma só mulher, temperante, sóbrio, modesto, hospitaleiro, apto para ensinar; não dado ao vinho, não violento, porém cordato, inimigo de contendas, não avarento; que governe bem a própria casa, criando os filhos sob disciplina, com todo o respeito (pois, se alguém não sabe governar a própria casa, como cuidará da igreja de Deus?); não seja neófito, para não suceder que se ensoberbeça e incorra na condenação do diabo. Pelo contrário, é necessário que tenha bom testemunho dos de fora, a fim de não cair no opróbrio e no laço do diabo. Semelhantemente, quanto a diáconos, é necessário que sejam respeitáveis, de uma só palavra, não inclinados a muito vinho, não cobiçosos de sórdida ganância, conservando o mistério da fé com consciência limpa. Também sejam estes primeiramente experimentados; e, se se mostrarem irrepreensíveis, exerçam o diaconato. Da mesma sorte, quanto a mulheres, é necessário que sejam elas respeitáveis, não maldizentes, temperantes e fiéis em tudo. O diácono seja marido de uma só mulher e governe bem seus filhos e a própria casa. Pois os que desempenharem bem o diaconato alcançam para si mesmos justa preeminência e muita intrepidez na fé que há em Cristo Jesus.",
  ...
  "2Tm 1:12": "Por essa razão, também sofro estas coisas, mas não me envergonho; porque sei em quem tenho crido e estou certo de que ele é poderoso para guardar o meu depósito até aquele Dia.",
  ...
  "Cl 2:7": "Arraigados e edificados nele, e confirmados na fé, tal como fostes instruídos, crescendo em ações de graças.",
  "Os 4:6": "O meu povo está sendo destruído, porque lhe falta o conhecimento; porque tu rejeitaste o conhecimento, também eu te rejeitarei.",
  "Ef 4:14": "Para que não sejamos mais como meninos, agitados de um lado para outro e levados ao redor por todo vento de doutrina, pela artimanha dos homens, pela astúcia com que induzem ao erro.",
  "2Tm 4:3": "Pois haverá tempo em que não suportarão a sã doutrina; pelo contrário, cercar-se-ão de mestres segundo as suas próprias cobiças.",
  "Mt 13:20-21": "O que foi semeado em solo rochoso, esse é o que ouve a palavra e a recebe logo, com alegria; mas não tem raiz em si mesmo, sendo, antes, de pouca duração; em lhe chegando a angústia ou a perseguição por causa da palavra, logo se escandaliza.",
  ...
  "1Pe 3:15": "Antes, santificai a Cristo, como Senhor, em vosso coração, estando sempre preparados para responder a todo aquele que vos pedir razão da esperança que há em vós, fazendo-o, todavia, com mansidão e temor.",
  ...
  "2Co 10:5": "Anulando nós sofismas e toda altivez que se levante contra o conhecimento de Deus, e levando cativo todo pensamento à obediência de Cristo.",
  "Tt 1:9": "Apegado à palavra fiel, que é segundo a doutrina, de modo que tenha poder tanto para exortar pelo reto ensino como para convencer os que o contradizem.",
  ...
  "2Ts 2:15": "Assim, pois, irmãos, permanecei firmes e guardai as tradições que vos foram ensinadas.",
  "Gn 2:24": "Por isso, deixa o homem pai e mãe e se une à sua mulher, tornando-se os dois uma só carne.",
  "Sl 68:6": "Deus faz que o solitário more em família.",
  "Sl 127:1": "Se o Senhor não edificar a casa, em vão trabalham os que a edificam.",
  "1Ts 4:3-4": "Pois esta é a vontade de Deus: a vossa santificação, que vos abstenhais da prostituição; que cada um de vós saiba possuir o próprio corpo em santificação e honra.",
  "Hb 13:4": "Digno de honra entre todos seja o matrimônio, bem como o leito sem mácula.",
  "Ml 2:15": "Não fez o Senhor um, mesmo que havendo nele um pouco de espírito? E por que somente um? Ele buscava a descendência que prometera. Portanto, cuidai de vós mesmos, e ninguém seja infiel para com a mulher da sua mocidade.",
  ...
  "2Co 6:14": "Não vos ponhais em jugo desigual com os incrédulos.",
  ...
  "Ef 5:33": "Não obstante, vós, cada um de per si também ame a própria esposa como a si mesmo, e a esposa respeite ao marido.",
  "1Pe 3:7": "Maridos, vós, igualmente, vivei a vida comum do lar, com discernimento; e, tendo consideração para com a vossa mulher como parte mais frágil, tratai-a com dignidade.",
  "Cl 3:18": "Esposas, sede submissas ao próprio marido, como convém no Senhor.",
  ...
  "Mt 7:12": "Tudo quanto, pois, quereis que os homens vos façam, assim fazei-o vós também a eles.",
  "At 20:35": "Mais bem-aventurado é dar que receber.",
  "1Co 13:4-8": "O amor é paciente, é benigno; o amor não arde em ciúmes, não se ufana, não se ensoberbece, não se conduz inconvenientemente, não procura os seus interesses, não se exaspera, não se ressente do mal; não se alegra com a injustiça, mas regozija-se com a verdade; tudo sofre, tudo crê, tudo espera, tudo suporta. O amor jamais acaba.",
  ...
  "Fp 2:3-4": "Nada façais por partidarismo ou vanglória, mas por humildade, considerando cada um os outros superiores a si mesmo. Não tenha cada um em vista o que é propriamente seu, senão também cada qual o que é dos outros.",
  ...
  "Ef 6:2-3": "Honra teu pai e tua mãe, que é o primeiro mandamento com promessa, para que te vá bem, e sejas de longa vida sobre a terra.",
  "Mt 19:5-6": "Por isso, deixará o homem pai e mãe e se unirá à sua mulher, tornando-se os dois uma só carne? De modo que já não são mais dois, porém uma só carne. Portanto, o que Deus ajuntou não o separe o homem.",
  ...
  "Mt 6:21": "Porque, onde está o teu tesouro, aí estará também o teu coração.",
  "Pv 24:27": "Cuida dos teus negócios lá fora, apronta a lavoura no campo e, depois, edifica a tua casa.",
  ...
  "Cl 1:16": "Pois, nele, foram criadas todas as coisas, nos céus e sobre a terra, as visíveis e as invisíveis. Tudo foi criado por meio dele e para ele.",
  "1Co 10:31": "Portanto, quer comais, quer bebais ou façais outra coisa qualquer, fazei tudo para a glória de Deus.",
  "Rm 8:29": "Porquanto aos que de antemão conheceu, também os predestinou para serem conformes à imagem de seu Filho.",
  ...
  "Mt 23:3": "Fazei e guardai, pois, tudo quanto eles vos disserem, porém não os imiteis nas suas obras; porque dizem e não fazem.",
...
// Versículos para o Ciclo 3 — Reforma Protestante e os 5 Solas
window.Verses["Rm 1:17"] = "Porque nele se revela a justiça de Deus de fé em fé; como está escrito: O justo viverá pela fé.";
window.Verses["Rm 1:16-17"] = "Porque não me envergonho do evangelho, pois ele é o poder de Deus para a salvação de todo aquele que crê; primeiro do judeu, e também do grego. Porque nele se revela a justiça de Deus de fé em fé; como está escrito: O justo viverá pela fé.";
window.Verses["Rm 3:23-24"] = "Porque todos pecaram e carecem da glória de Deus, sendo justificados gratuitamente pela sua graça, mediante a redenção que há em Cristo Jesus.";
window.Verses["Rm 3:22"] = "Isto é, a justiça de Deus mediante a fé em Jesus Cristo, para todos os que creem; porque não há distinção.";
window.Verses["Rm 6:1-2"] = "Que diremos, pois? Perseveraremos no pecado para que a graça se multiplique? De modo nenhum! Nós, que estamos mortos para o pecado, como ainda viveremos nele?";
window.Verses["Rm 9:16"] = "Portanto, isto não depende de quem quer, nem de quem corre, mas de Deus, que usa de misericórdia.";
window.Verses["Rm 11:6"] = "Mas, se é pela graça, já não é pelas obras; caso contrário, a graça já não é graça.";
window.Verses["Rm 11:36"] = "Porque dele, e por meio dele, e para ele são todas as coisas. A ele, pois, a glória eternamente. Amém.";
window.Verses["Ef 1:6"] = "Para o louvor da glória da sua graça, a qual nos concedeu gratuitamente no Amado.";
window.Verses["Ef 2:8"] = window.Verses["Ef 2:8-9"];
window.Verses["Ef 2:9"] = window.Verses["Ef 2:8-9"];
window.Verses["Ef 2:4-9"] = "Mas Deus, sendo rico em misericórdia, por causa do grande amor com que nos amou, e estando nós mortos em nossos delitos, nos deu vida juntamente com Cristo — pela graça sois salvos —, e juntamente com ele nos ressuscitou e nos fez assentar nos lugares celestiais em Cristo Jesus; para mostrar, nos séculos vindouros, a suprema riqueza da sua graça, em bondade para conosco em Cristo Jesus. Porque pela graça sois salvos, mediante a fé; e isto não vem de vós; é dom de Deus; não de obras, para que ninguém se glorie.";
window.Verses["Ef 2:18"] = "Porque por meio dele, tanto uns como outros, temos acesso ao Pai em um só Espírito.";
window.Verses["Jd 3"] = window.Verses["Jd 1:3"];
window.Verses["2Co 12:9"] = "Mas ele me disse: A minha graça te basta, porque o poder se aperfeiçoa na fraqueza. De boa vontade, portanto, me gloriarei nas fraquezas, para que sobre mim repouse o poder de Cristo.";
window.Verses["Tt 2:11-12"] = "Porque a graça de Deus se manifestou salvadora a todos os homens, educando-nos para que, renunciando à impiedade e às paixões mundanas, vivamos sensata, justa e piedosamente no presente século.";
window.Verses["2Pe 1:21"] = "Porque a profecia nunca teve como ponto de partida a vontade humana, mas os homens falaram da parte de Deus, sendo movidos pelo Espírito Santo.";
window.Verses["At 17:11"] = "Esses eram mais nobres do que os de Tessalônica; receberam a palavra com toda a avidez e examinavam todos os dias as Escrituras para ver se estas coisas eram assim.";
window.Verses["At 4:12"] = "E em nenhum outro há salvação, porque não existe nenhum outro nome debaixo do céu, dado entre os homens, pelo qual devamos ser salvos.";
window.Verses["Is 42:8"] = "Eu sou o Senhor! Esse é o meu nome; e a outro não darei a minha glória, nem o meu louvor às imagens entalhadas.";
window.Verses["Is 43:7"] = "Em todos os que são chamados pelo meu nome, e os quais criei para minha glória, a quem formei e fiz.";
window.Verses["Sl 19:1"] = "Os céus proclamam a glória de Deus, e o firmamento anuncia a obra das suas mãos.";
window.Verses["Hab 2:14"] = "Porque a terra se encherá do conhecimento da glória do Senhor, assim como as águas cobrem o mar.";
window.Verses["Ap 4:11"] = "Digno és, Senhor nosso e Deus, de receber a glória, a honra e o poder, porque tu criaste todas as coisas, e por tua vontade existiam e foram criadas.";
window.Verses["1Tm 2:5"] = "Porque há um só Deus e um só mediador entre Deus e os homens: Cristo Jesus, homem, que a si mesmo se deu em resgate por todos.";
window.Verses["Hb 4:14-16"] = "Tendo, pois, um grande sumo sacerdote, Jesus, Filho de Deus, que penetrou os céus, retenhamos a nossa confissão. Porque não temos sumo sacerdote que não possa compadecer-se das nossas fraquezas; antes, foi tentado em tudo como nós, mas sem pecado. Acheguemo-nos, portanto, com confiança ao trono da graça, para alcançarmos misericórdia e acharmos graça a fim de sermos ajudados em tempo oportuno.";
window.Verses["Hb 7:25"] = "Por isso pode salvar totalmente os que se chegam a Deus por meio dele, vivendo sempre para interceder por eles.";
window.Verses["Hb 9:28"] = "Assim também Cristo, havendo-se oferecido uma vez para tirar os pecados de muitos, aparecerá segunda vez, sem pecado, para a salvação dos que o aguardam.";
window.Verses["Mt 23:8-10"] = "Mas vós não sejais chamados Rabi, porque um só é o vosso Mestre, e vós todos sois irmãos. A ninguém na terra chameis vosso pai; porque um só é o vosso Pai, o celestial. Nem vos chameis guias, porque um só é o vosso Guia, o Cristo.";
window.Verses["Mt 27:51"] = "E eis que o véu do templo se rasgou em dois, de alto a baixo; e a terra tremeu, e as pedras se fenderam.";
